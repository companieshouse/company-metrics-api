artifact_name       := company-metrics-api
version             := unversioned
...
dependency-check:
	...
	DEPENDENCY_CHECK_SUPPRESSIONS_HOME="$${suppressions_home}" "$${suppressions_home}/scripts/depcheck" --repo-name=company-metrics-api
