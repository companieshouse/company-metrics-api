...
public interface AppointmentRepository extends MongoRepository<AppointmentDocument, String> {
    ...
    @Aggregation(pipeline = {""
            ...
            "    {"
            + "        $project: {"
            + "            'active_directors_count': { $ifNull: ['$active_directors.count', NumberInt(0)] },"
            + "            'active_secretaries_count': { $ifNull: ['$active_secretaries.count', NumberInt(0)] },"
            ...
            + "            'active_llp_members_count': { $ifNull: ['$active_llp_members.count', NumberInt(0)] }"
            + "        }"
            + "    }"
            + "]"})
